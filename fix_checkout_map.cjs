...
const regex = /return\s*\{\s*\.\.\.s,\s*paymentStatus:\s*'Paid'\s*as\s*const,\s*paidAmount:\s*s\.totalPrice,\s*unpaidAmount:\s*0,\s*settledPaymentMethod:\s*checkoutPaymentMethod\s*\};/g;
